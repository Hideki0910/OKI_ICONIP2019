...
\usepackage{bm}
\usepackage{comment}
\urldef{\mailsa}\path|{m181021, miyao, tkurita}@hiroshima-u.ac.jp|
...
\titlerunning{Siamese Network for Classification with Optimization of AUC}
...
%
\authorrunning{Hideki Oki  \and Junichi Miyao \and Takio Kurita}
% (feature abused for this document to repeat the title also on left hand pages)

% the affiliations are given next; don't give your e-mail address
% unless you accept that it will be published
\institute{Department of Information Engineering \\
...
%Therefore, also for the classification task of multi class, we also verify whether Siamese Network can optimize ROC-AUC.
